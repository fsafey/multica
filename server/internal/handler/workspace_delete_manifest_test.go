...
var workspaceDeletionManifest = map[string]workspaceDeleteAction{
	...
	"agent_runtime_pool":              workspaceDelete,
	...
	"runtime_pool_runtime":            workspaceDelete,
	...
	"task_execution_evidence":         workspaceDelete,
	...
	"workflow_node_dependency":        workspaceDelete,
	"workflow_node_resource":          workspaceDelete,
	"workflow_node_result":            workspaceDelete,
	"workflow_outbox":                 workspaceDelete,
	"workflow_resource_claim":         workspaceDelete,
