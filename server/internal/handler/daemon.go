...
// taskCompletionResult is the durable, user-visible task result. Transcript
// expectation fields belong to the daemon transport and are persisted in
// dedicated evidence columns, so they must never leak into this JSON shape.
...
func (h *Handler) CompleteTask(w http.ResponseWriter, r *http.Request) {
	...
	result, _ := json.Marshal(taskCompletionResult{
		PRURL:                 req.PRURL,
		Output:                req.Output,
