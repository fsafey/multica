...
func NewRouterWithOptions(pool *pgxpool.Pool, hub *realtime.Hub, bus *events.Bus, analyticsClient analytics.Client, rdb *redis.Client, opts RouterOptions) (chi.Router, *handler.Handler) {
	...
	r.Route("/api/daemon", func(r chi.Router) {
		...
		r.Post("/runtimes/{runtimeId}/tasks/{taskId}/workflow-lease", h.RenewWorkflowTaskLease)
		r.Post("/tasks/{taskId}/workflow-bundle", h.SubmitWorkflowBundle)
		r.Get("/workflow-integrations/{eventId}/bundle", h.DownloadWorkflowIntegrationBundle)
		r.Post("/workflow-integrations/{eventId}/lease", h.RenewWorkflowIntegrationLease)
		r.Post("/workflow-integrations/{eventId}/complete", h.CompleteWorkflowIntegration)
		r.Post("/workflow-integrations/{eventId}/fail", h.FailWorkflowIntegration)
