...
-- pass.
-- storage_key is the logical primary key, attached in migration 265 via a
-- CONCURRENTLY-built unique index (264) per the repo convention that every
-- migration index — including a new table's unique index — is created
-- concurrently in its own single-statement migration (see 243-245 for the
